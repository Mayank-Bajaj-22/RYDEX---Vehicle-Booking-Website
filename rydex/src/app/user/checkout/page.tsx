...
function page() {
    ...
    const pickUpLong = Number(params.get("pickUpLon"));
    const dropLat = Number(params.get("dropLat"));
    const dropLong = Number(params.get("dropLon"));
            ...
            <div className='relative max-w-6xl mx-auto z-10'>
                ...
                >
                    <div className='flex items-center gap-2 mb-2'>
                        ...
                        <span className='text-[10px] font-black uppercase trackin-[0.2em] text-zinc-400'>
                            Booking
                        </span>
                    </div>
                                                        ...
                                                        return (
                                                            ...
                                                            >
                                                                ...
                                                                <div className='flex-1 min-w-0'>
                                                                    ...
                                                                    <p className={`text-xs font-medium ${active ?
