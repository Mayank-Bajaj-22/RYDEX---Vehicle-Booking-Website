...
function page() {
    ...
    const fetchingPendingRequests = async () => {
        setLoading(true)
        try {
                                    ...
                                    bookings.map((b,i) => (
                                        ...
                                        >
                                            <div className='flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8'>
                                                ...
                                                <div className='flex flex-col justify-between lg:items-end gap-6 w-full lg:mx-auto'>
                                                    ...
                                                    <div className='flex gap-4 w-full lg:w-auto'>
                                                        ...
                                                        <button 
                                                            className='flex-1 lg:flex-none px-6 py-3 rounded-xl bg-black text-white text-sm font-semibold shadow-md hover:bg-gray-900 hover:shadow-lg transition-all active:scale-[0.98] disabled:opacity-50 flex items-center justify-center'
