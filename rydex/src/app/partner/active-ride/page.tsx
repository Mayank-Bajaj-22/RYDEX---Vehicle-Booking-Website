...
function page() {
    ...
    const handleSendPickUpOtp = async () => {
        try {
            const { data } = await axios.post("/api/partner/bookings/otp/pickup/send", {
    ...
    const handleVerifyDropOtp = async () => {
        ...
        try {
            const { data } = await axios.post("/api/partner/bookings/otp/drop/verify", {
                bookingId: booking?._id,
                otp: dropOtp
            });
            console.log(data);
    ...
    if (status === "completed" && booking) {
        return (
            <CompletedScreen booking={booking} role="partner" />
        )
    }
    ...
    return (
        <div className='h-screen w-full bg-zinc-100 flex flex-col lg:flex-row overflow-hidden'>
            ...
            >
                <div className="bg-zinc-950 px-6 py-5 flex shrink-0 flex-col">
                        ...
                        <AnimatePresence mode="wait">
...

                            {
                                status == "confirmed" && otpMode && !otpVerified && (
                                    <motion.div
                                        ...
                                        className="bg-zinc-50 border mx-auto border-zinc-200 rounded-2xl overflow-hidden"
                                    >
                                        ...
                                        <div className="p-4 space-y-3">
                                            <p className="text-xs text-zinc-500">
                                                Ask the customer for their 6-digit OTP to start the ride.
                                            </p>
                                            ...
                                            <div className="flex justify-center">
                                                <input
                                                    ...
                                                    className="w-48 border-2 border-zinc-200 focus:border-zinc-900 rounded-xl px-4.5 py-2 text-center text-xl tracking-[0.5em] font-black outline-none transition-colors placeholder:text-zinc-300 placeholder:tracking-normal placeholder:font-medium"
                                                />
                                            </div>
...

                            {
                                status == "started" && !dropOtpMode && (
                                    ...
                                    >
                                        <Navigation size={16} /> Mark As Dropped <ArrowRight size={15} className="ml-1" />
                                    </motion.button>
                                )
                            }

                            {
                                status == "started" && dropOtpMode && (
                                    ...
                                    >
                                        ...
                                        <div className="p-4 space-y-3">
                                            <p className="text-xs text-zinc-500">
                                                Ask the customer for their 6-digit OTP to complete the ride.
                                            </p>
                                            ...
                                            <div className="flex gap-2">
                                                ...
                                                <button
                                                    ...
                                                    disabled={loadingDropOtp || dropOtp.length < 6}
                                                    className="flex-1 bg-zinc-900 hover:bg-zinc-800 disabled:opacity-40 text-white py-2.5 rounded-xl text-sm font-bold active:scale-[0.97] transition-all"
                                                >
                                                    {
                                                        loadingDropOtp 
            ...
            <div className='lg:hidden fixed bottom-0 left-0 right-0 z-20 pointer-events-none'>
                ...
                >
                    ...
                    >
                        <div className="pt-3 pb-1 mx-auto">
