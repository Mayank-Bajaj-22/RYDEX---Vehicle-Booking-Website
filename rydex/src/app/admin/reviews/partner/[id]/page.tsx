                ...
                <div className='lg:col-span-2 space-y-8'>
                    <AnimateCard title="Vehicle Details" icon={<Car size={18} />}>
                        <div className='flex justify-between text-sm'>
                            ...
                            <span className='font-semibold'>{ vehicleDetails?.type.toUpperCase() || "-" }</span>
                        </div>
                        ...
                        <div className='flex justify-between text-sm'>
                            ...
                            <span className='font-semibold'>{ vehicleDetails?.vehicleModel.toUpperCase() || "-" }</span>
                        </div>
                    </AnimateCard>
                    ...
                    <AnimateCard title="Documents" icon={<FileText size={18} />}>
                        <div className='grid grid-cols-1 sm:grid-cols-3 gap-6'>
                            ...
                            <DocPreview label={"Driving Licence"} url={partnerDocs?.licenseUrl} />
