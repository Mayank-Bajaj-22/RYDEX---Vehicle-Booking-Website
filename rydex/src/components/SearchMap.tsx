...
const pickUpIcon = new L.DivIcon({
    html: `<div style="display: flex; flex-direction: column; align-items: center; filter: drop-shadow(0 6px 18px rgba(0,0,0,0.22))">
        <div style="
            ...
            white-space: nowrap;
            font-family: -apple-system,system-ui,san-serif;
...

                {
                    route.length > 0 && (
                        <>
                            <Polyline
                                positions={route}
                                pathOptions={{ color: "#0a0a0a", weight: 4, lineCap: "round", lineJoin: "round" }}
                            />
                        </>
                    )
                }
            ...
            <AnimatePresence>
                {
                    !ready && (
                        <motion.div
                            ...
                            className='absolute inset-0 z-999 bg-white/10 backdrop-blur-md flex flex-col items-center justify-center gap-4'
                        >
